...
return [
    ...
    'title' => 'CampusOS · Documentação da API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST do CampusOS — catálogo acadêmico, jornada do aluno e acervo compartilhado entre veteranos e calouros. Multi-tenant por instituição de ensino.',
    ...
    'laravel' => [
        ...
        // false: a UI é o Scalar (routes/web.php + resources/views/docs/api.blade.php),
        // lendo o openapi.yaml que o scribe:generate escreve em storage/app/private/scribe/.
        'add_routes' => false,
